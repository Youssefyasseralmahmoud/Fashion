...
//
//     final piecesinaccessories = piecesinaccessoriesFromJson(jsonString);
...
List<Piecesinaccessories> piecesinaccessoriesFromJson(String str) => List<Piecesinaccessories>.from(json.decode(str).map((x) => Piecesinaccessories.fromJson(x)));

String piecesinaccessoriesToJson(List<Piecesinaccessories> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class Piecesinaccessories {
  Piecesinaccessories({
  required  this.id,
  ...
  factory Piecesinaccessories.fromJson(Map<String, dynamic> json) => Piecesinaccessories(
    id: json["id"],
