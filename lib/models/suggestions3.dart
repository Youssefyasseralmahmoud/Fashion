...
//
//     final suggestions3 = suggestions3FromJson(jsonString);

import 'dart:convert';

List<Suggestions3> suggestions3FromJson(String str) => List<Suggestions3>.from(json.decode(str).map((x) => Suggestions3.fromJson(x)));

String suggestions3ToJson(List<Suggestions3> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Suggestions3 {
  ...
  factory Suggestions3.fromJson(Map<String, dynamic> json) => Suggestions3(
    id: json["id"],
