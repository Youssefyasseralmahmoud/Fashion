...
//
//     final suggestions2 = suggestions2FromJson(jsonString);

import 'dart:convert';

List<Suggestions2> suggestions2FromJson(String str) => List<Suggestions2>.from(json.decode(str).map((x) => Suggestions2.fromJson(x)));

String suggestions2ToJson(List<Suggestions2> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Suggestions2 {
  ...
  factory Suggestions2.fromJson(Map<String, dynamic> json) => Suggestions2(
    id: json["id"],
